...
const CommentComponent = ({
  ...
  const replyInput = (
    <Form reply>
      <Form.TextArea label="Reply" placeholder="Reply to comment..." onChange={(event) => setSingleReply(event.target.value)} />
    ...
    <div>
      <Comment>
        ...
        <Comment.Content>
          ...
          <Comment.Actions>
            <Comment.Action onClick={() => setReplyBoxState(!showReplyBox)}>Reply</Comment.Action>
          </Comment.Actions>
        </Comment.Content>
        <Comment.Group>
