...
async function createBlogs() {
  ...
  const blog1 = await Blogs.create({
    ...
    content:
      "It's very easy to make some javascript words **bold** and the other words *italic* with Markdown. You can even [link to Google!](http://google.com)",
  ...
  const blog2 = await Blogs.create({
    title:
      'How 10 simple Linux tips which save 50% of my time in the command line',
  ...
  const blog3 = await Blogs.create({
    title:
      'NodeJS: How To Run Scripts From The Terminal & Use Arguments in javascript',
    userId: '5d5ba0b0d14453a47b1a379a',
